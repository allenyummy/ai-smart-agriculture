...
if __name__ == '__main__':
    ...
    labeled_data = SupervisedDataSet(input_data, time_frequency)
    
    #--- genereate output decision ---#
    output_decision = pd.DataFrame(input_model.predict(labeled_data), columns=['B01', 'B02_1', 'B02_2', 'B03', 'B04'], index = labeled_data.index)
